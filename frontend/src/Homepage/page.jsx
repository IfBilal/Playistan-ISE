      ...
      <header className="homepage-header">
        <div className="header-content">
          ...
          <nav className="header-nav">
            <button className="nav-btn" onClick={() => navigate('/homepage')}>{t('welcome')}</button>
            ...
            <button className="nav-btn-change" onClick={handleChangePassword}>{t('changePassword')}</button>
            <button className="nav-btn-logout" onClick={handleLogout}>{t('logout')}</button>
          </nav>
        </div>
      </header>
